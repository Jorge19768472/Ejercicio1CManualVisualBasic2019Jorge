...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Inserte el 1 numero";
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(239, 81);
			...
			this->label2->Text = L"Inserte el 2 bumero";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(70, 136);
			...
			this->ClientSize = System::Drawing::Size(394, 253);
